...
def WasteDemand(project_base='default_38', project_waste='WasteDemand_38', db_name="cutoff38", db_waste_name="db_waste_cutoff38"):
    ...
    for name in names:
        ...
        arg = {"db_name":db_name, "query":query}
        args.append(arg)


    # def multi_run_wrapper(args):
    #     return WasteSearch(*args)

    pool.starmap_async(WasteSearch, args)
...
if __name__ == '__main__':
    ...
    args = []
    for dbase in dbases:
        arg = {'project_base':"default_"+dbase[-2:], 'project_waste':"WasteDemand_mp_"+dbase, 'db_name':dbase, 'db_waste_name':"db_waste_"+dbase}
        args.append(arg)

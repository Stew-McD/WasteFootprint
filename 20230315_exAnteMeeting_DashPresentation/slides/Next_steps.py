...
content = html.Div(
    [
        dbc.Row(style=dict(height="auto", position="auto", opacity=0.5), children=
            [
                dbc.Col([
                    html.Div(
                        style=dict(textAlign='left', fontSize=45, marginBottom=10, marginTop=5, marginLeft=350),
                        children=[
        ...
        dbc.Row(style=dict(height="auto", position="auto"), children=
            [
                dbc.Col([
                    html.Div(
                        style=dict(textAlign='right', fontSize=45, marginBottom=10, marginTop=0, marginRight=650),
                        children=[
                            html.B("Next steps..."),
                            html.H3("")
                            ]),
                    html.Div(
                        ...
                        children = [
                            ...
                            html.B("Extension with other 'demands'"),html.Br(),html.I('currently investigating the CRM list', style=dict(fontSize=25)),html.Br(),

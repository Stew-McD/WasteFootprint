...
fig_circ.write_html("CircularityRatio.html")
fig_total.write_html("TotalSolidWasteFootprint.html")
fig_scat.write_html("TotalSolidWasteFootprintVSCrustalScarcity.html")
    ...
    [
        dbc.Row(
            ...
            [
                dbc.Col([
                    html.Div(
                        style=dict(textAlign='left', fontSize=45, marginBottom=40, marginRight=0, marginTop=20, size=6),
                        children=[
                            html.B("Application of the WasteFootprint tool"),
                            html.H2("Macro-study in EcoInvent 3.9.1")
                            ]),
                    html.Div(
                        style=dict(textAlign='left', fontSize=25, marginRight=0, marginBottom=20),
                        children = [
                ...
                dbc.Col([
                    html.Div(
                        ...
                        children=[
                            html.Img(
                                style=dict(marginTop=40, height="100%",width="100%", ),
                                src=app.get_asset_url('corr.png'))
                            ]),

            ],style=dict(align='right', size=6))
